...
public class Area {
    ...
    private List<LuoghiDiInteresse> luoghiDiInteresse;
    ...
    public List<LuoghiDiInteresse> getLuoghiDiInteresse() {
        return luoghiDiInteresse;
    }
    public void setLuoghiDiInteresse(List<LuoghiDiInteresse> luoghiDiInteresse) {
        this.luoghiDiInteresse = luoghiDiInteresse;
    }
}
